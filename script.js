...
function verificarResposta() {
    ...
    if (chute == numeroPensado) {
        resultado.innerHTML = "<span style='color: green;'>Parabéns, você acertou!!!</span>";
        mostrarFogos();
        tentativas = 3;
        ...
        tentativas--;
        if(tentativas > 0) {
            resultado.innerHTML = "<span style='color: red;'>Você errou, Você tem " + tentativas + " tentativas restantes.</span>";
        } else {
            resultado.innerHTML = "<span style='color: red;'>Você errou todas! O número era " + numeroPensado + ". Continue tentando.</span>";
            tentativas = 3;
...
function mostrarFogos() {
    ...
    fireworks.innerHTML = '';
    for (var i = 0; i < 150; i++) { // Aumentando o número de fogos de artifício
    ...
    setTimeout(() => { fireworks.style.display = 'none'; }, 7000); // Aumentando o tempo total da animação
}
